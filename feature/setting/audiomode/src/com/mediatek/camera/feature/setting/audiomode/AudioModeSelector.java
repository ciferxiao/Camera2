...
public class AudioModeSelector extends PreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(getActivity().getResources().getString(R.string.audio_mode_title));
    ...
    private void filterValuesOnShown() {
        ...
        for (int i = 0; i < tempValues.size(); i++) {
            ...
            String title = generateTitle(value);
            if (title != null) {
    ...
    private String generateTitle(String currentValue) {
        if (AUDIO_MODE_NORMAL.equals(currentValue)) {
            return getActivity().getResources().getString(R.string.audio_mode_normal_title);
        } else if (AUDIO_MODE_INDOOR.equals(currentValue)) {
            return getActivity().getResources().getString(R.string.audio_mode_indoor_title);
        }
        return null;
    }
}
