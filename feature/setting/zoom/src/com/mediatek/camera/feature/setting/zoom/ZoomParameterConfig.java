...
public class ZoomParameterConfig implements ICameraSetting.IParametersConfigure,
     ...
     */
    public ZoomParameterConfig(ISettingManager.SettingDeviceRequester settingDeviceRequester,IApp App) {
        mSettingDeviceRequester = settingDeviceRequester;
        mApp = App;// add  RCS  Preview放大1.7倍 liuxi 20180724 
    }
    ...
    public void configCommand(CameraProxy cameraProxy) {
        ...
        synchronized (mSyncSmoothState) {
            android.util.Log.d("xiao111"," mzoomlevel " + mZoomLevel);
    ...
    private String getZoomRatio() {
        ...
        android.util.Log.d("xiao111","x" + String.format(Locale.ENGLISH, PATTERN, zoomValue));
