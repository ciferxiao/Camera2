...
public class MatrixDisplay extends SettingBase implements
    ...
    private void enterMatrixDisplay() {
        ...
        mViewManager.setMirror(FRONT_CAMERA.equals(mSettingController.getCameraId()));
    ...
    private View.OnClickListener mEntryViewClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            if (!mPreviewStarted && mDisplayConfig instanceof MatrixDisplayParametersConfig) {
                LogHelper.d(TAG, "[onClick], preview isn't started, return");
                return;
            }
