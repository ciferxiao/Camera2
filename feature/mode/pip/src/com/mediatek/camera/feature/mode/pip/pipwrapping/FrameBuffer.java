...
/**
 * Frame buffer object wrapper class.
 */
public class FrameBuffer {
    ...
    /**
     * Set renderer size.
     * @param width the renderer size's width.
     * @param height the renderer size's height.
     */
