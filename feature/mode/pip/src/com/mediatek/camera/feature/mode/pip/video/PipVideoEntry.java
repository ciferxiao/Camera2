...
/**
 * Pip video mode entry.
 */
public class PipVideoEntry extends FeatureEntryBase {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(PipVideoEntry.class.getSimpleName());
     ...
     */
    public PipVideoEntry(Context context, Resources resources) {
    ...
    public String getFeatureEntryName() {
        return PipVideoEntry.class.getName();
    }
    ...
    private boolean isFeatureOptionSupported() {
        ...
        LogHelper.i(TAG, "[isFeatureOptionSupported] pip video enable = " + enable);
        return enable;
    }
}