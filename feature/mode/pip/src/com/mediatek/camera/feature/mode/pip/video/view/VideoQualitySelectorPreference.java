 ...
 */
public class VideoQualitySelectorPreference extends PreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(getActivity().getResources().getString(R.string.pip_video_quality_title));
        addPreferencesFromResource(R.xml.pip_video_quality_selector_preference);
