 ...
 */
package com.mediatek.camera.feature.mode.pip.video.view;
 ...
 */
public class PipVideoQualitySettingView implements ICameraSettingView {
    private static final Tag TAG = new Tag("Pip-VideoQuality");
    public static final String KEY_PIP_VIDEO_QUALITY = "key_pip_video_quality";
    ...
    private VideoQualitySelectorPreference mSelectorPreference;
     ...
     */
    public PipVideoQualitySettingView(Listener changeListener,
    ...
    private void createEntryTitles() {
        ...
        for (String value : mEntryValues) {
            ...
            switch (videoQualityArea) {
                ...
                case QUALITY_FHD_2:
                    videoQualityTitle =
                            mActivity.getResources().getString(R.string.pip_quality_fhd);
                    break;
                case QUALITY_HD:
                    videoQualityTitle =
                            mActivity.getResources().getString(R.string.pip_quality_hd);
                    break;
                case QUALITY_VGA_1:
                case QUALITY_VGA_2:
                    videoQualityTitle =
                            mActivity.getResources().getString(R.string.pip_quality_vga);
                    break;
                default:
                    break;
            }
    ...
    private void initVideoQualitySelectorPreference() {
        mSelectorPreference = new VideoQualitySelectorPreference();
    ...
    private void initVideoQualityPreference(PreferenceFragment fragment) {
        fragment.addPreferencesFromResource(R.xml.pip_video_quality_preference);
        mVideoQualityPreference = (Preference)
                fragment.findPreference("pip_video_quality_preference");
        mVideoQualityPreference.setId(R.id.pip_video_quality_setting);
        mVideoQualityPreference.setContentDescription(
                mActivity.getResources().getString(
                        R.string.pip_video_quality_content_description));
        mVideoQualityPreference.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(android.preference.Preference preference) {
                ...
                transaction.replace(R.id.setting_container,
                        mSelectorPreference, "pip_video_quality_selector").commit();
                return true;
            }
        });
    }
    ...
    private class VideoQualitySelectorPreferenceClickListener implements OnPreferenceClickListener {
        ...
        public boolean onPreferenceClick(android.preference.Preference preference) {
            ...
            mDataStore.setValue(KEY_PIP_VIDEO_QUALITY,
                    mSelectedValue,
