...
public class PanoramaBase extends CameraModeBase implements PreviewCallback, CameraStateCallback {
    ...
    public void onCameraOpened() {
        ...
        String pictureSizes = mSettingController.queryValue(KEY_PICTURE_SIZE);
        mStatusChangeListener.onStatusChanged(KEY_PICTURE_SIZE, pictureSizes);
        ...
        public void surfaceAvailable(SurfaceHolder surfaceHolder, int width, int height) {
            ...
            synchronized ((Object) mIsResumed) {
                if (mIPanoramaDeviceController != null && mIsResumed) {
                    mIPanoramaDeviceController.updatePreviewSurface(surfaceHolder);
                }
            }
        }
