...
public class VideoHelper {
    ...
    public void releasePreviewFrameData() {
        LogHelper.d(TAG, "[releasePreviewData] mCameraPreviewData = null ");
    ...
    public void startSwitchCameraAnimation(String cameraId) {
        LogHelper.d(TAG, "[startSwitchCameraAnimation] ");
    ...
    public void startChangeModeAnimation(String cameraId) {
        LogHelper.d(TAG, "[startChangeModeAnimation] mCameraPreviewData = " + mCameraPreviewData);
    ...
    private String createFileName(boolean isVideo, String  title) {
        LogHelper.d(TAG, "[createFileName] + isVideo = " + isVideo + " title = " + title);
    ...
    private String convertOutputFormatToFileExt(int outputFileFormat) {
        if (outputFileFormat == MediaRecorder.OutputFormat.MPEG_4) {
            LogHelper.d(TAG, "[convertOutputFormatToFileExt] return .mp4");
            return ".mp4";
        }
        LogHelper.d(TAG, "[convertOutputFormatToFileExt] return .3gp");
        return ".3gp";
    }
    ...
    private void stopSwitchCameraAnimation() {
        if (mApp != null) {
            LogHelper.d(TAG, "stopSwitchCameraAnimation");
