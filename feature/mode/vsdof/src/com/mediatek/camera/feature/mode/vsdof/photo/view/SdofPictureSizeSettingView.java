...
public class SdofPictureSizeSettingView implements ICameraSettingView {
    ...
    private static final int PICTURE_SIZE_5M = 3072 * 1728;
    private static final int PICTURE_SIZE_8M = 3072 * 2304;
    private static final int PICTURE_SIZE_9M = 4096 * 2304;
    ...
    private void createEntryTitles() {
        ...
        for (String value : mEntryValues) {
            Size pictureSize = CameraUtil.getSize(value);
            int pictureSizeArea = pictureSize.getWidth() * pictureSize.getHeight();
            String pictureSizeTitle = null;
            switch (pictureSizeArea) {
                case PICTURE_SIZE_5M:
                    pictureSizeTitle = "5M(16:9)";
                    break;
                case PICTURE_SIZE_8M:
                    pictureSizeTitle = "8M(4:3)";
                    break;
                case PICTURE_SIZE_9M:
                    pictureSizeTitle = "9M(16:9)";
                    break;
                case PICTURE_SIZE_13M:
                    pictureSizeTitle = "13M(4:3)";
                    break;
                default:
                    break;
            }
