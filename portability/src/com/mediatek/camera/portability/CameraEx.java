...
public class CameraEx {
    ...
    public static String getProperty(String key, String val) {
        return Camera.getProperty(key, val);
    }
    ...
    public void setVendorDataCallback(Camera camera, int msgId,
        ...
        switch (msgId) {
            ...
            case MTK_CAMERA_MSG_EXT_NOTIFY_METADATA_DONE:
                camera.setRaw16Callback(new DngMetadataCallbackImpl(),
                        new DngPictureCallbackImpl());
                break;
            ...
            case MTK_CAMERA_MSG_EXT_NOTIFY_IMAGE_UNCOMPRESSED:
                if (Build.VERSION.SDK_INT > API_22) {
                    camera.setUncompressedImageCallback(new UncompressedImageCallbackImpl());
                }
                break;
    ...
    /**
     * Dng metadata callback implementer.
     */
    private class DngMetadataCallbackImpl implements MetadataCallback {
        ...
        public void onMetadataReceived(CaptureResult result, CameraCharacteristics characteristic) {
            ...
            msg.obj = new MessageInfo(result, characteristic);
