...
package com.mediatek.camera.portability.jpeg.encoder;
...
class HwJpegEncodeImpl extends JpegEncoder {
    private static final String TAG = "CamAp_" + HwJpegEncodeImpl.class.getSimpleName();
    ...
    HwJpegEncodeImpl(Context context) {
        mEffectHalHandler = createHandler("CamAp_JpegEncoder");
