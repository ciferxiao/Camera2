...
public interface IAppUiListener {
    ...
    interface ISurfaceStatusListener {
        /**
         * Invoked when a surfaceHolder is ready for use.
         * @param surfaceHolder The created surfaceHolder.
         * @param width The width of the surfaceHolder
         * @param height The height of the surfaceHolder
         */
        void surfaceAvailable(SurfaceHolder surfaceHolder, int width, int height);

        /**
         * Invoked when the surfaceHolder's buffers size changed.
         *
         * @param surfaceHolder The changed surfaceHolder/
         * @param width The new width of the surfaceHolder
         * @param height The new height of the surfaceHolder
         */
        void surfaceChanged(SurfaceHolder surfaceHolder, int width, int height);

        /**
         * Invoked when the specified surfaceHolder is about to be destroyed.
         *
         * @param surfaceHolder The surfaceHolder about to be destroyed
         */
