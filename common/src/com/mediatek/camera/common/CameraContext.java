...
public class CameraContext implements ICameraContext {
    ...
    // add  RCS  当前镜头 liuxi 20180725  start
    @Override
    public boolean isEyeMirror() {
        return mIApp.isEyeMirror();
    }

    @Override
    public boolean isEarMirror() {
        return mIApp.isEarMirror();
    }

    @Override
    public boolean isSkinMirror() {
        return mIApp.isSkinMirror();
    }

    @Override
    public boolean isCommonMirror() {
        return mIApp.isCommonMirror();
    }

    @Override
    public boolean isUnMedicalMirror() {
        return mIApp.isUnMedicalMirror();
    }
    ...
    @Override
    public int providerStartPreViewTime() {
       return mIApp.providerStartPreView();
    }
