...
public final class CameraUtil {
    ...
    public static final String KEY_ORGAN = "key_organ";
    /**
    ...
    public static final String KEY_RULER_LEFT_POINT_X_VALUES = "ruler_left_x_value";
    public static final String KEY_RULER_LEFT_POINT_Y_VALUES= "ruler_left_y_value";
    public static final String KEY_RULER_RIGHT_POINT_X_VALUES = "ruler_right_x_value";
    public static final String KEY_RULER_RIGHT_POINT_Y_VALUES = "ruler_right_y_value";
    /**
     * 检眼镜
     */
    public static final String EYE_KEY_ORGAN = "key_organ";
    public static final String EYE_KEY_PHOTO_MODE_RCS="eye_key_photo_mode_rcs";
    public static final String EYE_KEY_SHOT_MODE_RCS="eye_key_shot_mode_rcs";
    public static final String EYE_KEY_EXPOSURE_MODE_RCS="eye_key_exposure_mode_rcs";
    public static final String EYE_KEY_FOCUS_MODE_RCS= "eye_key_focus_mode_rcs";
    public static final String EYE_KEY_FOCUS_PROGRESS_VALUE= "eye_key_focus_progress";
    public static final String EYE_KEY_EXPOSURE_PROGRESS_VALUE= "eye_key_exposure_progress";
    public static final String EYE_KEY_INFRARED_PROGRESS_VALUE= "infrared_progress_value";

    /**
     * 检耳镜 liuxi add
     */
    public static final String EAR_KEY_ORGAN = "ear_key_organ";
    public static final String EAR_KEY_PHOTO_MODE_RCS="ear_key_photo_mode_rcs";
    public static final String EAR_KEY_SHOT_MODE_RCS="ear_key_shot_mode_rcs";
    public static final String EAR_KEY_EXPOSURE_MODE_RCS="ear_key_exposure_mode_rcs";
    public static final String EAR_KEY_FOCUS_MODE_RCS= "ear_key_focus_mode_rcs";
    public static final String EAR_KEY_FOCUS_PROGRESS_VALUE= "ear_key_focus_progress";
    public static final String EAR_KEY_EXPOSURE_PROGRESS_VALUE= "ear_key_exposure_progress";

    /**
     * 皮肤镜 liuxi add
     */
    public static final String SKIN_KEY_PHOTO_MODE_RCS="skin_key_photo_mode_rcs";
    public static final String SKIN_KEY_SHOT_MODE_RCS="skin_key_shot_mode_rcs";
    public static final String SKIN_KEY_EXPOSURE_MODE_RCS="skin_key_exposure_mode_rcs";
    public static final String SKIN_KEY_FOCUS_MODE_RCS= "skin_key_focus_mode_rcs";
    public static final String SKIN_KEY_FOCUS_PROGRESS_VALUE= "skin_key_focus_progress";
    public static final String SKIN_KEY_EXPOSURE_PROGRESS_VALUE= "skin_key_exposure_progress";

    /**
     * 通用镜 liuxi add
     */
    public static final String COMMON_KEY_PHOTO_MODE_RCS="common_key_photo_mode_rcs";
    public static final String COMMON_KEY_SHOT_MODE_RCS="common_key_shot_mode_rcs";
    public static final String COMMON_KEY_EXPOSURE_MODE_RCS="common_key_exposure_mode_rcs";
    public static final String COMMON_KEY_FOCUS_MODE_RCS= "common_key_focus_mode_rcs";
    public static final String COMMON_KEY_FOCUS_PROGRESS_VALUE= "common_key_focus_progress";
    public static final String COMMON_KEY_EXPOSURE_PROGRESS_VALUE= "common_key_exposure_progress";
    ///end
    /**
     * 默认不保存 liuxi add
     */
    public static final String NORMAL_KEY_ORGAN = "normal_key_organ";
    public static final String NORMAL_KEY_PHOTO_MODE_RCS="normal_key_photo_mode_rcs";
    public static final String NORMAL_KEY_SHOT_MODE_RCS="normal_key_shot_mode_rcs";
    public static final String NORMAL_KEY_EXPOSURE_MODE_RCS="normal_key_exposure_mode_rcs";
    public static final String NORMAL_KEY_FOCUS_MODE_RCS= "normal_key_focus_mode_rcs";
    public static final String NORMAL_KEY_FOCUS_PROGRESS_VALUE= "normal_key_focus_progress";
    public static final String NORMAL_KEY_EXPOSURE_PROGRESS_VALUE= "normal_key_exposure_progress";
    /**
     * patient info 
     * xiao add 
     */
    public static final String KEY_PATIENT_RESULT = "patient_result";
    public static final String KEY_FRIST_NAME = "first_name";
    public static final String KEY_LAST_NAME = "last_name";
    public static final String KEY_BRITH_FETCH = "brith_fetch";
    public static final String KEY_GENDER_FETCH = "gender_fetch";
    public static final String ACTION_PATIENT="com.android.camera.action.RCSINFO";
     ...
     */
    public static Size getSizeByTargetRatio(
