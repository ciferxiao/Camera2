...
public class PhotoDeviceAction {
    ...
    static final int MSG_EXPOSURE_SETTING_VALUES = 18;
    //add RCS 曝光功能增加 liuxi 20180725 end

    static final int MSG_ZOOM_SETTING_VALUES = 19;

    static final int MSG_RCS_UVC_PAUSE = 20;
    
    static final int MSG_RCS_UVC_RESUME = 21;
    ...
    static String stringify(int operation) {
        switch (operation) {
            ...
            //add RCS 曝光功能增加 liuxi 20180725 start
            case MSG_EXPOSURE_SETTING_VALUES:
                return "msgexposuresettingvalues";
            //add RCS 曝光功能增加 liuxi 20180725 end
            case MSG_ZOOM_SETTING_VALUES:
                return "msgzoomsettingvalues";
            default:
