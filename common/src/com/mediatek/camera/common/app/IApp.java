...
public interface IApp {
    ...
    int getGSensorOrientation();
     ...
     MedicalMirror.MirrorId EarMedicalMirror();
     MedicalMirror.MirrorId EyeMedicalMirror();
     MedicalMirror.MirrorId CommonMedicalMirror();
     MedicalMirror.MirrorId SkinMedicalMirror();
     MedicalMirror.MirrorId UnMedicalMirror();
     MedicalMirror.MirrorId getCameraMirrorState();

     RcsMirrorInterface getRcsMirrorInterface();
     PreferencesUtils getPreferencesUtils();
     boolean isEyeMirror();
     boolean isEarMirror();
     boolean isSkinMirror();
     boolean isCommonMirror();
     boolean isUnMedicalMirror();

     int getCurrentMirrorFocusMode();
     int getCurrentMirrorExposureMode();
     int getCurrentMirrorShotMode();
     int getCurrentMirrorPhotoMode();
     int getCurrentEarMirrorOrganMode();
     int getCurrentEyeMirrorOrganMode();

     void setMirrorFocusMode(int value);
     void setMirrorExposureMode(int value);
     void setMirrorShotMode(int value);
     void setMirrorPhotoMode(int value);
     void setEarMirrorOrganMode(int value);
     void setEyeMirrorOrganMode(int value);
     boolean isAutoFocus();
     boolean isManualFocus();
     ICameraMode getICameraMode();
     boolean isPatientsInfoDisplay();
     boolean isLeftHandMode();
     int providerStartPreView();
     void removeStartPreviewHandler();
     void setPreFocusProgress(int values);
     void setPreExposureProgress(int values);
    void setPreInfraredProgress(int values);
     int getPreFocusProgress();
     int getPreExposureProgress();
     int getPreInfraredProgress();
     boolean noUseDefaultValue();
     int getCurrentLight();
     int getCurrentRuleUnit();
     void  showToast();
     void setUVCVideoViewTrueState();
     void setUVCVideoViewFalseState();
     //xiao add for picture name 
     ...
     float getCurrentLeftX();
     float getCurrentLeftY();
     float getCurrentRightY();
     float getCurrentRightX();
     float getValueK();
     ...
     void setUvcConnectState(boolean value);
     
     //xiao add for ruler proportion callback

    //add wangchao
    Bitmap getMainPicBitmap();
}
