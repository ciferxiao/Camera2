...
public class ShutterButtonManager extends AbstractViewManager implements
    ...
    protected View getView() {
        ...
        mApp.getAppUi().registerGestureListener(mShutterLayout.getGestureListener(), 20);
    ...
    public void registerDone() {
        ...
        //add Rcs 屏蔽View liuxi start 20180713 start
        int index = 0;
        ...
        //add Rcs 屏蔽View liuxi start 20180713 end
    }
